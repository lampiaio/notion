...
class Application {
  ...
  constructor() {
    ...
    add('https://raw.githubusercontent.com/lampiaio/notion/main/rain2/alpha.png').
    add('https://raw.githubusercontent.com/lampiaio/notion/main/rain2/shine.png').
    add('https://raw.githubusercontent.com/lampiaio/notion/main/rain2/background.jpg').
    add('https://raw.githubusercontent.com/lampiaio/notion/main/rain2/foreground.jpg').
...
class EffectCanvas {
  ...
  constructor(width, height, loader) {
    ...
    shaderData.uniforms.uTextureDropShine.value = loader.resources['https://raw.githubusercontent.com/lampiaio/notion/main/rain2/shine.png'].texture;
    shaderData.uniforms.uTextureBackground.value = loader.resources['https://raw.githubusercontent.com/lampiaio/notion/main/rain2/background.jpg'].texture;
    shaderData.uniforms.uTextureForeground.value = loader.resources['https://raw.githubusercontent.com/lampiaio/notion/main/rain2/foreground.jpg'].texture;
    shaderData.uniforms.vTextureSize.value = [
    loader.resources['https://raw.githubusercontent.com/lampiaio/notion/main/rain2/background.jpg'].texture.width,
    loader.resources['https://raw.githubusercontent.com/lampiaio/notion/main/rain2/background.jpg'].texture.height];
...
class DropletManager {
  ...
  constructor(stage, loader) {
    ...
    this.dropletSmallTexture = loader.resources['https://raw.githubusercontent.com/lampiaio/notion/main/rain2/alpha.png'].texture;
    this.dropletLargeTexture = loader.resources['https://raw.githubusercontent.com/lampiaio/notion/main/rain2/alpha.png'].texture;
