...
function init() {
    ...
    // Planet
    const texturePlanet = loader.load('https://raw.githubusercontent.com/lampiaio/notion/main/NOTdreamingofjupiter/saturn3-ljge5g.jpg');
...
//   scene.add(planet);
    ...
    //Moon
    const textureMoon = loader.load('https://raw.githubusercontent.com/lampiaio/notion/main/NOTdreamingofjupiter/moon-ndengb.jpg');
...
//    scene.add(moon);
    ...
    // Sphere Background 
    const textureSphereBg = loader.load('https://raw.githubusercontent.com/lampiaio/notion/main/NOTdreamingofjupiter/stars2-qx9prz.jpg');
